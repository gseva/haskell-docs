...
\renewcommand{\footrulewidth}{0.4pt}
  ...
  \input{partes/syntax.tex}

  \input{partes/types.tex}

  \input{partes/inference.tex}

  \input{partes/recursion.tex}

  \input{partes/gc.tex}

  \input{partes/higherorder.tex}

  \input{partes/data.tex}

  \input{partes/io.tex}

  \input{partes/modules.tex}

  \input{partes/functors.tex}

  \input{partes/monads.tex}

  \input{partes/zippers.tex}

  \input{partes/concurrency.tex}

  \input{partes/stm.tex}

  \input{partes/usecases.tex}
